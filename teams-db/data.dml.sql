...
INSERT INTO teams (name) VALUES
	('Formateurs'), ('P�dagogique');
	
INSERT INTO members (first_name, last_name, home_address_id) VALUES
	('J�r�my', 'BOJKO', (SELECT t.id FROM addresses t WHERE t.road = '14 Rue de la Beaune')),
...
INSERT INTO teams_members VALUES 
	...
	((SELECT t.id FROM teams t WHERE t.name = 'P�dagogique'), (SELECT t.id FROM members t WHERE t.last_name = 'LUONG')),
	((SELECT t.id FROM teams t WHERE t.name = 'P�dagogique'), (SELECT t.id FROM members t WHERE t.last_name = 'DAUGUET'));
